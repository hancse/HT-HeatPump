...
HEOS.update(CoolProp.PQ_INPUTS, P1, 1)
h1test = HEOS.hmass()
s1test = HEOS.smass()
...
#HEOS.update(CoolProp.PSmass_INPUTS, P3s, s2)
HEOS.update(CoolProp.PT_INPUTS, P2, 310)
...
#T3stest = HEOS.p()
#s3stest = HEOS.smass()
#HEOS.update(CoolProp.PT_INPUTS, P1, T2)
...
print("Calculated_COP %02f:" % Calculated_COP)
